...
$APPLICATION->SetPageProperty("keywords", "Мы предлагаем быстрые и качественные автомобили");
$APPLICATION->SetPageProperty("description", "Мы предлагаем широкий ассортимент автомобилей по адекватным ценам.");
$APPLICATION->SetTitle("Интернет-магазин \"Авто\"");
